...
public abstract class TextureRenderer {
    ...
    public static final String LOG_TAG = "renderer";
    ...
    public void TextureRenderer() {}

    public static class Viewport {
        public int x, y; // toạ độ vẽ view
        public int width, height;  // width + height của view
        public int startY, startX;  // toạ độ frame được cắt
        public int cutX, cutY;  // width + height frame muốn cắt
        public Viewport() {}
